...
void print_sphere_content(t_figure *pFigures) {
	...
	printf("Color: %f %f %f %f\n", pFigures->figure_body.sphere.RGB_color->red, pFigures->figure_body.sphere.RGB_color->green, pFigures->figure_body.sphere.RGB_color->blue, pFigures->figure_body.sphere.RGB_color->transparency);
}
